    ...
    <>
      <StructuredData type="BreadcrumbList" data={{
        items: [
          ...
          { name: cityData.name, url: `/woningen/${citySlug}` }
        ]
      }} />
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
                Woningen te koop in {cityData.name}
              </h1>
              <p className="text-xl text-gray-600 max-w-3xl mx-auto mb-8">
                Ontdek woningen in {cityData.name} van particuliere verkopers zonder makelaarskosten.
              </p>
              ...
              <Card>
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-gray-600 mb-6">
                    Er zijn momenteel geen woningen beschikbaar in {cityData.name}. 
